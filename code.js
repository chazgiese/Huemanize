var plugin = (() => {
  ...
  var useMode = (definition28) => {
    converters[definition28.mode] = __spreadValues(__spreadValues({}, converters[definition28.mode]), definition28.toMode);
  ...
  var convertRgbToXyz65 = (rgb2) => {
    let { r: r2, g, b, alpha } = convertRgbToLrgb_default(rgb2);
    let res = {
      mode: "xyz65",
  ...
  var definition13 = __spreadProps(__spreadValues({}, definition_default12), {
    mode: "lab65",
    parse: ["--lab-d65"],
    serialize: "--lab-d65",
    toMode: {
  ...
  var definition15 = __spreadProps(__spreadValues({}, definition_default14), {
    mode: "lch65",
    parse: ["--lch-d65"],
    serialize: "--lch-d65",
    toMode: {
  ...
  var definition17 = __spreadProps(__spreadValues({}, definition_default), {
    mode: "lrgb",
    toMode: {
  ...
  var definition19 = __spreadProps(__spreadValues({}, definition_default12), {
    mode: "oklab",
    toMode: {
  ...
  var definition20 = __spreadProps(__spreadValues({}, definition_default14), {
    mode: "oklch",
    toMode: {
  ...
  var definition21 = __spreadProps(__spreadValues({}, definition_default), {
    mode: "p3",
    parse: ["display-p3"],
